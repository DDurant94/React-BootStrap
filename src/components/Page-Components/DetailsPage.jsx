...
const CharacterDetails = ({params}) => {
  ...
  if(gettingData) return <div className="m-5 p-3 d-flex justify-content-center"><Spinner animation="border" variant="danger" className="m-5 p-3 d-flex justify-content-center"/></div>;
  
  return (
    <section className="container-fluid-center m-1 p-3 bg-black text-light rounded shadow font-monospace border border-danger">
      ...
      <div className="row g-3">
        ...
        <div className="col-12 container-fluid-center p-1">

          <div className="">

            <img className='img-fluid rounded shadow mx-auto d-block' style={{width: 480+"px", height: "auto"}} src={`${characterData[0].thumbnail.path}.${characterData[0].thumbnail.extension}`} alt={`Picture of ${characterData[0].name}`}/>

          </div>

        </div>

        <div className="col-12 container-fluid-center p-3 border border-white rounded">
          ...
          <div className="row g-2">
            ...
            <div className="col-lg-6 col-md-6 col-sm-6 container-fluid-center p-3 border border-white rounded">
      ...
      {<NavLink to='/character-library'><button className="btn btn-danger my-4 border border-white" >Close Details</button></NavLink>}
